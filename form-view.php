...
//    }
    ...
    if(empty($_POST["city"])){
        echo $cityErr = '<div class="alert alert-danger" role="alert">
                   City is required
                        </div>';
    } else{
        $city = $_POST["city"];
    ...
    if(empty($_POST["street"])){
        ...
        echo $strErr = '<div class="alert alert-danger" role="alert">
                   Street is required
                        </div>';
    } else{
        $street = $_POST["street"];
    ...
    if(empty($_POST["streetnumber"])){
        echo $strnumErr = '<div class="alert alert-danger" role="alert">
        ...
        if (is_numeric($streetnum)) {
            ...
            echo $strnumErr = '<div class="alert alert-danger" role="alert">Street No: Numbers Only accepted</div>';PHP_EOL;
    ...
    if(empty($_POST["zipcode"])){
       echo $zipcodeErr = '<div class="alert alert-danger" role="alert">Zipcode  is required</div>';    }
        ...
        if (is_numeric($zipcode)) {
            ...
            echo $zipcode = '<div class="alert alert-danger" role="alert">Zipcode : Numbers Only accepted</div>';PHP_EOL;
    ...
    if (empty($_POST["email"])) {
        echo $emailErr = '<div class="alert alert-danger" role="alert">Email is required</div>';    } else {
